...
<nav class="navbar navbar-expand-lg navbar-light bg-light py-3">
  <div class="container"><a href="#" class="navbar-brand d-flex align-items-center"> <i class="fa fa-graduation-cap text-primary mr-2"></i><strong>Quản lý khảo sát</strong></a>
    <button type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation" class="navbar-toggler"><span class="navbar-toggler-icon"></span></button>
    <div id="navbarSupportedContent" class="collapse navbar-collapse">
      <ul class="navbar-nav ml-auto">
        <li class="nav-item active"><a href="#" class="nav-link font-bold"> Quản trị hệ thống </a></li>
        <li class="nav-item active"><a href="#" class="nav-link font-bold"> Bắt đầu dựng khảo sát </a></li>
        <li class="nav-item active"><a href="#" class="nav-link font-bold"> Xem mẫu khảo sát đã tạo</a></li>
        <li class="nav-item active"><a href="#" class="nav-link font-bold"> Về chúng tôi </a></li>
